      ...
      <div className="stats2-max-width thq-section-max-width">
        ...
        <div className="stats2-container3 thq-flex-column">
          <span className="thq-body-small">
            {props.content1 ?? (
              <Fragment>
                <span className="stats2-text22">Easy Customization</span>
              </Fragment>
            )}
          </span>
          <h2 className="thq-heading-2">
            {props.heading1 ?? (
              <Fragment>
                <span className="stats2-text27">Key Stats</span>
              </Fragment>
            )}
          </h2>
          <p className="thq-body-large">
            {props.content2 ?? (
              <Fragment>
                <span className="stats2-text23">Fast Loading Speed</span>
              </Fragment>
            )}
          </p>
          <div className="stats2-container4 thq-grid-2">
            <div className="stats2-container5">
              <h2 className="thq-heading-2">
                {props.stat1 ?? (
                  <Fragment>
                    <span className="stats2-text21">Responsive Design</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
            ...
            <div className="stats2-container6">
              <h2 className="thq-heading-2">
                {props.stat2 ?? (
                  <Fragment>
                    <span className="stats2-text29">Customization Options</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
          ...
          <div className="stats2-container7 thq-grid-2">
            <div className="stats2-container8">
              <h2 className="thq-heading-2">
                {props.stat3 ?? (
                  <Fragment>
                    <span className="stats2-text24">Loading Speed</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
            ...
            <div className="stats2-container9">
              <h2 className="thq-heading-2">
                {props.stat4 ?? (
                  <Fragment>
                    <span className="stats2-text25">Customer Satisfaction</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
